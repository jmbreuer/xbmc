...
void CGUIDialogSubtitleSettings::InitializeSettings()
{
  ...
  if (SupportsSubtitleFeature(IPC_SUBS_STRETCH))
  {
    ...
    entries.clear();
    entries.push_back(TranslatableIntegerSettingOption(39203, ST_STRETCH_NONE));
    entries.push_back(TranslatableIntegerSettingOption(39204, ST_STRETCH_2425));
    entries.push_back(TranslatableIntegerSettingOption(39205, ST_STRETCH_2524));
  
    AddSpinner(groupSubtitles, SETTING_SUBTITLE_STRETCH, 39202, SettingLevel::Basic, videoSettings.m_subtitleStretch, entries);
  }
