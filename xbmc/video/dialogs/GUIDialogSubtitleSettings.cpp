...
void CGUIDialogSubtitleSettings::InitializeSettings()
{
  ...
  if (SupportsSubtitleFeature(IPC_SUBS_STRETCH))
  {
    ...
    entries.clear();
    entries.push_back(IntegerSettingOption(g_localizeStrings.Get(39199), ST_FPS_SAME));
    ...
    AddSpinner(groupSubtitles, SETTING_SUBTITLE_FPS, 39198, SettingLevel::Basic, videoSettings.m_subtitleFPS, entries);
  }
